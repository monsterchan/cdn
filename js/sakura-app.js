  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.2/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.2/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.2/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = 'https://cdn.jsdelivr.net/monsterchan/cdn@1.2/img/fail/image404.png'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.2/img/fail/image404.png'
  }
}
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/sakura.png')
  changeBG('#gribs-bg', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/star.png')
  changeBG('#KAdots-bg', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/point.png')
  changeBG('#totem-bg', 'https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/monsterchan/cdn@1.1/img/other/starry_sky.png)')
...
function show_date_time () {
  BirthDay = new Date('20/06/2019 21:00:00')
  today = new Date()
  timeold = (today.getTime() - BirthDay.getTime())
  sectimeold = timeold / 1000
  secondsold = Math.floor(sectimeold)
...
$(function () {
  ...
  console.log('%c chan %c', 'background:#24272A; color:#ffffff', '', 'https://www.chenkequan.cn/')
  console.log('%c Github %c', 'background:#24272A; color:#ffffff', '', 'https://github.com/monsterchan')
})
